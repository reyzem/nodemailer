...
router.get('/passsrecovery', async (req, res, next)=>{
  mailSender(
    "erikreyezz@gmail.com",
    "Test de Envio de Correo",
    //"Esto es un prueba de correo"
    '<h1>Esto es un prueba de correo</h1><p>Click aqui para setear contraseña <a href="https://account.mongodb.com/account/reset/password?email=erim_reyesm%40unicah.edu">CLICK ME</></p>'
  );
